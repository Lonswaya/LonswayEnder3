...
#define CUSTOM_MACHINE_NAME "Lonsway's Ender-3 Printer"
...
#define DEFAULT_AXIS_STEPS_PER_UNIT   { 79.79, 79.96, 406.11, 98.58 }
 ...
 *     O-- FRONT --+
 */
#define NOZZLE_TO_PROBE_OFFSET { -44, -5, -0.71 }
